...
/* @var $model backend\modules\schl\models\search\BeasiswaMahasiswaSearch */
...
<div class="beasiswa-search">
    ...
    <?php // echo $form->field($model, 'syarat_ipk') ?>

    <?php // echo $form->field($model, 'syarat_penghasilan_ortu') ?>
