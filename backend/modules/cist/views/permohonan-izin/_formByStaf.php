                    ...
                    <div class="">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2">Jenis Izin</label>
                            ...
                            <!--DATE RANGE-->
                            <div class="form-group">
                                <label class="control-label col-sm-2">Waktu Izin</label>
                                <div class="input-group col-sm-8">
                                    <div id="mdp-demo" style="margin-left: 48px"></div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <!--LAMA IZIN-->
                            <div class="form-group">
                                <label class="control-label col-sm-2">Lama Izin (Hari)</label>
                                <div class="input-group col-sm-8">
                            ...
                            <!--ALASAN IZIN-->
                            <div class="form-group">
                                <label class="control-label col-sm-2">Alasan Izin</label>
                                <div class="input-group col-sm-8">
                            ...
                            <!--PENGALIHAN TUGAS-->
                            <div class="form-group">
                                <label class="control-label col-sm-2">Pengalihan Tugas</label>
                                <div class="input-group col-sm-8">
                            ...
                            <!--SURAT SAKIT-->
                            <div class="form-group">
                                <label class="control-label col-sm-2">Lampiran Surat Sakit</label>
                                <div class="input-group col-sm-8">
