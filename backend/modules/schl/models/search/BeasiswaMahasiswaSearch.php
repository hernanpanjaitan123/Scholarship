...
/**
 * BeasiswaMahasiswaSearch represents the model behind the search form about `backend\modules\schl\models\Beasiswa`.
 */
class BeasiswaMahasiswaSearch extends Beasiswa
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['syarat_ipk', 'syarat_penghasilan_ortu'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'syarat_ipk' => $this->syarat_ipk,
            'syarat_penghasilan_ortu' => $this->syarat_penghasilan_ortu,
