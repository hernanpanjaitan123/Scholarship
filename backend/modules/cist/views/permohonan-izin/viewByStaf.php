...
$this->title = 'Detil Permohonan Izin';
$this->params['breadcrumbs'][] = ['label' => 'Permohonan Izin', 'url' => ['index-by-staf']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="permohonan-izin-view">

    <?php if ($model->statusIzin->status_by_atasan == 1 || $model->statusIzin->status_by_wr2 == 1){ ?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-times"></i> Batalkan', ['cancel-by-staf', 'id' => $model->permohonan_izin_id], ['class' => 'btn btn-warning']) ?>
            </p>
        </div>
    <?php } ?>
