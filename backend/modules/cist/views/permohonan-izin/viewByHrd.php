...
<div class="permohonan-izin-view">
    ...
    <?php if ($model->statusIzin->status_by_atasan == 6 && $model->statusIzin->status_by_wr2 == 1) { ?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-check"></i> Setuju sebagai WR 2', ['accept-by-wr2-hrd', 'id' => $model->permohonan_izin_id], ['class' => 'btn btn-success']) ?>
                <?php echo Html::a('<i class="fa fa-times"></i> Tolak sebagai WR 2', ['reject-by-wr2-hrd', 'id' => $model->permohonan_izin_id], ['class' => 'btn btn-danger']); ?>
            </p>
        </div>
    <?php } else if ($model->statusIzin->status_by_wr2 == 1) {?>
        <div class="pull-right">
            <p>
                <?= Html::a('<i class="fa fa-check"></i> Setuju sebagai Atasan', ['accept-by-atasan-hrd', 'id' => $model->permohonan_izin_id], ['class' => 'btn btn-success']) ?>
                <?php echo Html::a('<i class="fa fa-times"></i> Tolak sebagai Atasan', ['reject-by-atasan-hrd', 'id' => $model->permohonan_izin_id], ['class' => 'btn btn-danger']); ?>
            </p>
        </div>
    <?php } ?>
                    ...
                    <div class="stepwizard-row setup-panel">
                        ...
                        if($model->statusIzin->status_by_atasan == 1){
                            ...
                            if($model->statusIzin->status_by_wr2 == 1) {
                                ...
                                echo '<div class="stepwizard-step col-md-4">
                                        <a href="#step-4" type="button" class="btn btn-success btn-circle disabled">2</a>
                                        <p>WR 2</p>
                                       </div>';
                            }
